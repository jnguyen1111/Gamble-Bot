...
public class SignUp {
    ...
    public void signupUser(MessageReceivedEvent event,boolean userExist,DataBase server){
        ...
        if(!userExist){
            ...
            String message = signupEmote+"**WELCOME!** <@" + event.getJDA().getSelfUser().getIdLong() + ">" + " has bestowed you the lifestyle of Gamble Addiction" + signupEmote + " " + user;
    ...
    public void signupUser(MessageChannel eventChannel, boolean userExist,DataBase server, long userID, ButtonInteractionEvent event){
        if(!userExist){
            ...
            String message = signupEmote+"**WELCOME!** <@" + eventChannel.getJDA().getSelfUser().getIdLong() + ">" + " has bestowed you the lifestyle of Gamble Addiction -" + userTag + " " + signupEmote;
