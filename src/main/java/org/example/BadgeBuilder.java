...
public class BadgeBuilder {
    ...
    public String buildBadge(List<String> badgeDetails, String badgeName) {
        ...
        if (badgeType.equals("animated")) return badge = "<a:" + badgeName + ":" + badgeID + "> " + badgeTag;
        else if (badgeType.equals("static")) return badge = "<:" + badgeName + ":" + badgeID + "> " + badgeTag;
        else return badgeID + " " + badgeTag;
    }
}
