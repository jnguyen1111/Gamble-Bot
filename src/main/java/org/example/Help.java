...
public class Help extends ListenerAdapter {
    ...
    public SnakeEye snakeEyeObject = new SnakeEye();
    ...
    public String tradeMarkMessage = "© 2022 CsLotto Inc. All Rights Reserved.";
    ...
    public ArrayList<String> gameCommandNames = new ArrayList<>(Arrays.asList("coinflip", "diceroll", "slots", "fish", "jackpotsize", "spinwheel","snakeeyes"));
    ...
    public Help(Character PREFIX){
        ...
        regularCommandTable.put("shop", new ArrayList<>(Arrays.asList(":scroll:", "Shows CsLotto's Megacenter for commands on sale \nEX: " + PREFIX + "shop")));
        ...
        regularCommandTable.put("gift", new ArrayList<>(Arrays.asList(":gift:", "Gifts CsLottoCoins to recipient specified \nEX: " + PREFIX + "gift (amount ex: 10) @(valid user here)\n " + PREFIX + "gift 10 @Tariq")));
        regularCommandTable.put("top", new ArrayList<>(Arrays.asList(":medal:", "See the leaderboard of the top 10 richest Gamble Addicts on the server. \nEX: " + PREFIX + "top")));
        ...
        gameCommandTable.put("diceroll", new ArrayList<>(Arrays.asList(":game_die:", "Win by rolling a 3 or a 6, if you roll a 6 you get a bonus bet multiplier\nMultiplier: 100%, 150%, 200%, 300%, 350%, 500%" + "\n EX: " + PREFIX + "diceroll 500  BET RANGE: (" + diceRollObject.diceGameMinAmount + "-" + diceRollObject.diceGameMaxAmount + ")")));
        gameCommandTable.put("slots", new ArrayList<>(Arrays.asList(":slot_machine:", "Win by rolling 3 of the same emote on a spin OR by landing atleast one lucky 7. Slots comes with two jackpots, one jackpot of $40k that's won by landing 3 books, and the grand jackpot of 77k for landing 3 lucky 7s." +
                "\nMultiplier: 100%, 150%, 200%, 250%, 275%, 300%, 350% 500%" + "\n EX: " + PREFIX + "slots 5000  BET RANGE: (" + slotsObject.slotGameMinAmount + "-" + slotsObject.slotGameMaxAmount  + ")")));
        gameCommandTable.put("fish", new ArrayList<>(Arrays.asList(":fishing_pole_and_fish:", "reward values: 100, 200, 300, 350, 400, 450, 500, 550, 600, 1000 \nCost per line due to CsLotto Tax: 20 \nEX: " + PREFIX + "fish")));
        ...
        gameCommandTable.put("snakeeyes", new ArrayList<>(Arrays.asList(":game_die:",
                "Rolls two die, to win you must land two dices that are both on the one side of the die  \nWIN MULTIPER: 36X \nEX: "
                + PREFIX + "snakeeyes 20000  BET RANGE: (" + snakeEyeObject.snakeEyesMinAmount + "-" + snakeEyeObject.snakeEyesMaxAmount + ")")));
