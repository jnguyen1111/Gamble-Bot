...
public class Slots {
    ...
    int bookJackpot = 100000;
    int grandJackpot = 300000;
    ...
    public String calculateMultiplier(){
        ...
        switch(multiplier){
            ...
            case 4:
                ...
                break;
            case 5:
                userReq += userReq * 2.75;
                bonusVal = "275%";
                break;
            case 6:
                userReq += userReq * 3.00;
                bonusVal = "300%";
                break;
            case 7:
                userReq += userReq * 3.5;
    ...
    public void buildSlotEmbed(MessageReceivedEvent event, ArrayList<String> reelsResults, String userBetReq){
        ...
        if(didUserWin(reelsResults)){
            ...
            if(reelsResults.get(0).equals(book) && !reelsResults.contains(lucky7)) {
                ...
                slotEmbed.setDescription("You win the **jackpot** of **" + String.valueOf(bookJackpot) + "**!!!!" + jackpotEmote);
            ...
            slotEmbed.setTitle("You lost! :angry: " + moneyCash + moneyCash+ moneyCash);
            slotEmbed.addField(embedDividerText, reelDisplay + "\nMultiplier: 0%", false);
        ...
        if(validInput(bet,server,event)) {
            ...
            if(didUserWin(reelResults)){
                ...
                if(reelResults.get(0).equals(book) && !reelResults.contains(lucky7))
                    ...
                    updateCredits(server, event, userReq + grandJackpot, true);
                }
                else{ //default wins
