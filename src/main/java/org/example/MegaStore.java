...
public class MegaStore extends ListenerAdapter {
    ...
    ActionRow defActionRow = ActionRow.of(
            Button.primary("commands", "Command Shop"),
            Button.primary("badges", "Badge Shop"),
            Button.primary("banners", "Banner Shop"),
            Button.danger("exit", "Exit ✖")
    );

    //create shop embed and return it
    public void createShopEmbed(HashMap<String, List<String>> localCommandList, LinkedHashMap<String, List<String>> localBadgeList, HashMap<String, List<String>> localBannerList) {
...
//        shopEmbed.addField("Code[Coogs]\n" + badge.buildBadge(cocoBadgeDetails,"codecoogs"), stackCashEmote + "Price: " + cocoBadgeDetails.get(4), true);
        shopEmbed.addField("Top Deals from the command shop:", "In stock in Cslotto's Commands Shop", false);
        ...
        shopEmbed.addField("COMING SOON", "In stock in Cslotto's Commands Shop", true);
        shopEmbed.addField("COMING SOON", "In stock in Cslotto's Commands Shop", true);
